...
toggleThemeBtn.addEventListener('click', () => {
  ...
  // LƯU CHẾ ĐỘ DARK/LIGHT MODE VÀO LOCALSTORAGE
...
// CHECK , ĐỘ PHÂN GIẢI MÀN HÌNH NHỎ NHẤT LÀ 1024px
if (window.matchMedia('(min-width: 1024px)').matches) {
  // ẨN NÚT KHI CẦN THIẾT
...
// ===================================
// ĐĂNG NHIỀU ẢNH 
// TẠO NÚT CHUYỂN ẢNH KHI ĐĂNG NHIỀU ẢNH
posts.forEach((post) => {
...
// THÊM NÚT TÍNH NĂNG VÀO MỖI BÀI POST 
